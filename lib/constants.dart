...
const double kBottomContainerEdgeInset = 10.0;

const double kIconSize = 80.0;
const double kSizedBoxHeight = 15.0;

const double kCardEdgeInset = 15.0;
const double kCardBoxRadius = 10.0;
...
const kResultTextStyle = TextStyle(
    color: Color(0xFF24D876), fontSize: 45.0, fontWeight: FontWeight.bold);
